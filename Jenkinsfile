                             ...
                             parallel(
                                   Informacoes_da_build: {
                                    ...
                                    Copiando_git:{
                                     ...
                                     git url: 'https://github.com/marquescode/aws-ci-pipeline.git'
         ...
         stage('Testes OK?') {
            ...
            steps {
                    script {
                        ...
                        parameters: [choice(choices: 'Sim,Testes Realizados pode destruir\nAplicar em Produção', description: 'Select Ambiente', name: 'Build'), string(defaultValue: '', description: '', name: 'Descrição')],  submitterParameter: 'APPROVER'
